...
var MarkerSpiderfier = (exports.MarkerSpiderfier = (function(
  ...
  function MarkerSpiderfier(props, context) {
    ...
    console.log("map", _this2.context[_constants2.MAP])
    var markerSpiderfier = new window.OverlappingMarkerSpiderfier(
      _this2.context[_constants2.MAP]
    )
    ...
    _this2.state = (0, _defineProperty3.default)(
      {},
      _constants2.MARKER_SPIDERFIER,
      markerSpiderfier
    )
    return _this2
  }
  ...
  ;(0, _createClass3.default)(MarkerSpiderfier, [
    {
      ...
      value: function getChildContext() {
        ...
        var markerSpiderfier = this.state[_constants2.MARKER_SPIDERFIER]
        return (
          (_ref = {}),
    ...
    },
    {
      ...
      value: function componentDidMount() {
        ;(0, _MapChildHelper.componentDidMount)(
          this,
          this.state[_constants2.MARKER_SPIDERFIER],
          eventMap
        )
